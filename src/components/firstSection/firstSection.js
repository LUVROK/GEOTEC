            ...
            <div className='firstSection_block'>
                <div className='firstSection_block_geotec_block'>
                    <div className='firstSection_block_geotec element-animation'>
                        ...
                        - надежный партнер<br />в области геодезических изысканий<br />в Казахстане
                    </div>
                    <div className='firstSection_block_geotec_perhapse_block element-animation'>
                        <div className='firstSection_block_geotec_perhapse'>
                            <span className='engFont'>TOO «GEOTEC»</span> было основано в <span className='engFont'>2006</span> году с целью работы в области геодезических и проектных<br />работ в Казахстане. На данный момент <span className='engFont'>GEOTEC</span> является надежным партнером, работая<br />с престижными и известными клиентами.
                        </div>
                        <div className='firstSection_block_geotec_perhapse top_sec'>
                            Головной офис <span className='engFont'>TOO «GEOTEC»</span> был перенесен в Астану из Актобе в <span className='engFont'>2016</span> году. Остальные офисы<br />расположены в Актобе и Тенгизе, Атырау. <span className='engFont'>GEOTEC</span> выполняет проекты в Казахстане и других странах<br />СНГ. <span className='engFont'>GEOTEC 100%</span> местная казахстанская компания. Достижение местного контента составляет <span className='engFont'>95%</span>.
                        </div>
                    </div>
                </div>
