...
const Projects = () => {
  ...
  const [MassDiscriptionBlockOverflow, setMassDiscriptionBlockOverflow] = useState();
  const [MasshiddenOverflowBlockOverflow, setMasshiddenOverflowBlockOverflow] = useState();
  ...
  useEffect(() => {
    setMassImagesBlockOverflow(document.querySelectorAll(".ImagesBlockOverflow"));
    setMassDiscriptionBlockOverflow(document.querySelectorAll(".textDesc_block"));
    setMasshiddenOverflowBlockOverflow(document.querySelectorAll(".hiddenOverflowProject"));
  }, []);
  ...
  useEffect(() => {
    ...
    if (MassImagesBlockOverflow !== undefined) {
      ...
      MassImagesBlockOverflow[activePrev2].style.transform = "translateX(-160%)";
  ...
  return (
    <div className="Projects Projects_section sec2">
      <div className="Projects_Text_desc" style={{ transform: "translateX(-100%)" }}>
        <svg className="svgcloseprojects" onClick={closeMoreInfo} width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="Projects_Text_desc_text">
          <div className="Projects_Text_desc_text_title">{parse(t("projects.Projects_Text_desc_text_title"))}</div>
          <div className="Projects_Text_desc_text_discription">
            <span className="textDesc_block" style={{display: 'block'}}>{parse(t("projects.Projects_Text_desc_text_discription1"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription2"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription3"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription4"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription5"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription6"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription7"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription8"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription9"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription10"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription11"))}</span>
            <span className="textDesc_block" style={{display: 'none'}}>{parse(t("projects.Projects_Text_desc_text_discription12"))}</span>
          </div>
        </div>
      </div>
      <div className="Projects_block element-animation">
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "block" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text1"))}</div>
            ...
            <div className="Button_Learn_More" onClick={opanMoreInfo}>
              <div className="title">{parse(t("projects.Button_Learn_More"))}</div>
              <div>
                <svg width="29" height="19" viewBox="0 0 29 19" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M20.1562 0C20.1562 4.83249 24.0738 8.75 28.9062 8.75V9.75C24.0738 9.75 20.1562 13.6675 20.1562 18.5H19.1562C19.1562 14.661 21.375 11.3402 24.6001 9.75H0V8.75H24.6001C21.375 7.15981 19.1562 3.83901 19.1562 0H20.1562Z" />
                </svg>
              </div>
            </div>
          </div>
        </div>
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          {parse(t("projects.title"))}
          <div
            className="textBlockpr textBlock_first active"
            id="first"
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text2"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text3"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text4"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text5"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text6"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text7"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text8"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text9"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text10"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text11"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow hiddenOverflowProject" style={{ display: "none" }}>
          ...
          >
            <div className="textBlock_text">{parse(t("projects.textBlock_text12"))}</div>
            <div className="textBlock_text_content">
        ...
        <div className="hiddenOverflow2">
          <div className="ImagesBlockOverflow active" style={{ transform: "translateX(0%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(160%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(270%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(370%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(370%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(370%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(370%)", opacity: "1" }}></div>
          <div className="ImagesBlockOverflow" style={{ transform: "translateX(370%)", opacity: "1" }}></div>
          ...
          <div className="buttonsBlock">
            <div className="btnBefore btnHoverProjects" style={{ pointerEvents: "all" }} onClick={() => pageFunctionto(0)}>
            ...
            <div className="btnAfter btnHoverProjects" style={{ pointerEvents: "all" }} onClick={() => pageFunctionto(1)}>
              <svg width="29" height="19" viewBox="0 0 29 19" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: "scale(1,1)" }}>
                <path fillRule="evenodd" clipRule="evenodd" d="M20.1562 0C20.1562 4.83249 24.0738 8.75 28.9062 8.75V9.75C24.0738 9.75 20.1562 13.6675 20.1562 18.5H19.1562C19.1562 14.661 21.375 11.3402 24.6001 9.75H0V8.75H24.6001C21.375 7.15981 19.1562 3.83901 19.1562 0H20.1562Z" fill="white" />
              </svg>
            </div>
          ...
          <div className="StatusBar">
            <div className="status">{active <= 8 && active >= 0 ? `0${active + 1}` : active + 1}</div>
