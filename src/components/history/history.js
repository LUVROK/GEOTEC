      ...
      function handleTouchMove(evt) {
        ...
        if (Math.abs(xDiff) > Math.abs(yDiff)) {
          ...
          if (xDiff > 0) {
            ...
            const els_n = document.querySelectorAll(".TimeHistoryBox_element");
            const activeEl = document.querySelectorAll(
              ".TimeHistoryBox_element"
            );
            let activeElem;
            ...
            if (indexEl !== 0) {
              currentCorrectActive(
                textBlockAll[indexElPrev].id,
                els_n[indexElPrev].id,
                indexEl - 1,
                true
              );
            } else {
    ...
    >
        ...
        <div className="hiddenOverflow">
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text1"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content1"))}
            </div>
          ...
          <div
            className="textBlock textBlock_second"
            id="second"
            style={{
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text2"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content2"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_third"
            id="third"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text3"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content3"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_fourth"
            id="fourth"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text4"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content4"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_fifth"
            id="fifth"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text5"))}
            </div>
            <div className="textBlock_text_content">
              <span className="textBlock_textPopins">
                {parse(t("History.textBlock_text_content5"))}
              </span>
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_sixth"
            id="sixth"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text6"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content6"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_seventh"
            id="seventh"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text7"))}
            </div>
            <div className="textBlock_text_content">
              <span className="textBlock_textPopins">
                {parse(t("History.textBlock_text_content7"))}
              </span>
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_eight"
            id="eight"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text8"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content8"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_tenth"
            id="tenth"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text9"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content9"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_eleventh"
            id="eleventh"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text">
              {parse(t("History.textBlock_text10"))}
            </div>
            <div className="textBlock_text_content">
              {parse(t("History.textBlock_text_content10"))}
            </div>
            <div className="ImageBack">
          ...
          <div
            className="textBlock textBlock_twelveth"
            id="twelveth"
            style={{
              transform: "translateY(-950px)",
              transition: "all 0.6s cubic-bezier(0,.11,.29,1)",
          ...
          >
            <div className="textBlock_text lasttextBlock_text">
              {parse(t("History.textBlock_text11"))}
            </div>
      ...
      <div className="TimeHistoryBox" id="TimeHistoryBox">
        <div className="TimeHistoryBox_block">
          <div
            className="TimeHistoryBox_element active"
            id="TimeHistoryBox_element_2006"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("first", "TimeHistoryBox_element_2006", 0)
            }
          >
            2006
          </div>
          <div
            ...
            id="TimeHistoryBox_element_2007"
            style={{ display: "block" }}
            onClick={() =>
          ...
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2009"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("third", "TimeHistoryBox_element_2009", 2)
            }
          >
            2009
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2011"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("fourth", "TimeHistoryBox_element_2011", 3)
            }
          >
            2011
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2012"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("fifth", "TimeHistoryBox_element_2012", 4)
            }
          >
            2012
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2014"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("sixth", "TimeHistoryBox_element_2014", 5)
            }
          >
            2014
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2014_2"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive(
                "seventh",
                "TimeHistoryBox_element_2014_2",
                6
              )
            }
          >
          ...
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2015"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("eight", "TimeHistoryBox_element_2015", 7)
            }
          >
            2015
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2016"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("tenth", "TimeHistoryBox_element_2016", 8)
            }
          >
            2016
          </div>
          <div
            className="TimeHistoryBox_element"
            id="TimeHistoryBox_element_2020"
            style={{ display: "block" }}
            onClick={() =>
              currentCorrectActive("eleventh", "TimeHistoryBox_element_2020", 9)
            }
          >
            2020
          </div>
          <div
            className="TimeHistoryBox_element lastTimeHistoryBox_element "
            style={{ display: "block" }}
            id="TimeHistoryBox_element_2023"
            onClick={() =>
              currentCorrectActive(
                "twelveth",
                "TimeHistoryBox_element_2023",
                10
              )
            }
          >
      ...
      <div className="backgroundHistorySvg">
        ...
        >
          <circle
            ...
            cy="247.5"
            r="247.5"
            fill="url(#paint0_radial_774_382)"
          />
          <rect
            width="310"
            height="209"
            rx="20"
            transform="matrix(-1 0 0 1 310 118)"
            fill="url(#pattern0)"
          />
          <defs>
            <pattern
            ...
            >
              <use
                xlinkHref="#image0_774_382"
                transform="translate(-0.0967965) scale(0.000932495 0.00138313)"
              />
            </pattern>
            <defs>
              <radialGradient
                id="paint0_radial_774_382"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(290.5 247.5) rotate(90) scale(247.5)"
              >
                <stop stopColor="#83E6DB" stopOpacity="0.59" />
                <stop
                  offset="0.739583"
                  stopColor="#CAF5F0"
                  stopOpacity="0.207083"
                />
